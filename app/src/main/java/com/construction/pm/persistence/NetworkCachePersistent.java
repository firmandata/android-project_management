...
public abstract class NetworkCachePersistent {
    ...
    protected enum NetworkCachePersistentType {
        ...
        INSPECTOR_PROJECT_ACTIVITY_LIST(2), INSPECTOR_PROJECT_ACTIVITY_MONITORING_LIST(6),
        MANAGER_PROJECT_ACTIVITY_LIST(7), MANAGER_PROJECT_ACTIVITY_MONITORING_LIST(8), MANAGER_PROJECT_ACTIVITY_UPDATE_LIST(9),
        FILE(5);
