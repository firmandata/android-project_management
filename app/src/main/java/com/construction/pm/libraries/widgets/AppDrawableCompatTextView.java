...
public class AppDrawableCompatTextView extends AppCompatTextView {
    public AppDrawableCompatTextView(Context context) {
        super(context);
    }

    public AppDrawableCompatTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(context, attrs);
    }

    public AppDrawableCompatTextView(Context context, AttributeSet attrs, int defStyleAttr) {
