...
public class CameraAspectRatioFragment extends DialogFragment {
    ...
    public static CameraAspectRatioFragment newInstance(Set<AspectRatio> ratios,
                                                  AspectRatio currentRatio) {
        final CameraAspectRatioFragment fragment = new CameraAspectRatioFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final CameraAspectRatioAdapter adapter = new CameraAspectRatioAdapter(ratios, current);
        return new AlertDialog.Builder(getActivity())
                .setAdapter(adapter, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int position) {
                        mListener.onCameraAspectRatioSelected(ratios[position]);
                    }
                })
                .create();
    }

    private static class CameraAspectRatioAdapter extends BaseAdapter {

        private final AspectRatio[] mRatios;
        private final AspectRatio mCurrentRatio;

        CameraAspectRatioAdapter(AspectRatio[] ratios, AspectRatio current) {
            mRatios = ratios;
    ...
    public interface Listener {
        void onCameraAspectRatioSelected(@NonNull AspectRatio ratio);
    }
