...
import com.construction.pm.activities.fragments.CameraAspectRatioFragment;
...
public class CameraActivity extends AppCompatActivity implements
        ...
        CameraAspectRatioFragment.Listener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.file_photo_camera_layout);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.camera_navigator, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.camera_aspect_ratio:
                if (mCameraView != null) {
                    final Set<AspectRatio> ratios = mCameraView.getSupportedAspectRatios();
                    final AspectRatio currentRatio = mCameraView.getAspectRatio();
                    CameraAspectRatioFragment.newInstance(ratios, currentRatio)
                            .show(getSupportFragmentManager(), FRAGMENT_DIALOG);
                }
                break;
            case R.id.camera_switch_flash:
                if (mCameraView != null) {
                ...
                break;
            case R.id.camera_switch_camera:
                if (mCameraView != null) {
    ...
    @Override
    public void onCameraAspectRatioSelected(@NonNull AspectRatio ratio) {
        if (mCameraView != null) {
    ...
    private CameraView.Callback mCallback = new CameraView.Callback() {
        ...
        public void onPictureTaken(CameraView cameraView, final byte[] data) {
            ...
            Toast.makeText(cameraView.getContext(), R.string.camera_picture_taken, Toast.LENGTH_SHORT)
                    .show();
