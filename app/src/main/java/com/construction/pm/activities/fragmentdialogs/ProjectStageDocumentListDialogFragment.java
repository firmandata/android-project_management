...
public class ProjectStageDocumentListDialogFragment extends DialogFragment implements ProjectStageDocumentListAdapter.ProjectStageDocumentListAdapterListener {
    ...
    public void onProjectStageDocumentListAdapterRequestFileInfo(final int position, Integer fileId) {
        ...
        fileInfoGetAsyncTask.execute(new FileInfoGetAsyncTaskParam(getContext(), settingUserModel, fileId));
    }
