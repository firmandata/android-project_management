...
public class InspectorProjectActivityMonitoringSaveAsyncTaskParam {
    ...
    public InspectorProjectActivityMonitoringSaveAsyncTaskParam(final Context context, final SettingUserModel settingUserModel, final ProjectActivityMonitoringModel projectActivityMonitoringModel, final ProjectMemberModel projectMemberModel) {
        mContext = context;
