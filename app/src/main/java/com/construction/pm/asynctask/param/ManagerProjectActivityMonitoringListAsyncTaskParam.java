...
public class ManagerProjectActivityMonitoringListAsyncTaskParam {
    protected Context mContext;
    protected SettingUserModel mSettingUserModel;
    protected ProjectActivityModel mProjectActivityModel;
    protected ProjectMemberModel mProjectMemberModel;

    public ManagerProjectActivityMonitoringListAsyncTaskParam(final Context context, final SettingUserModel settingUserModel, final ProjectActivityModel projectActivityModel, final ProjectMemberModel projectMemberModel) {
        mContext = context;
