...
public class ProjectStageAssignCommentListAsyncTaskParam {
    ...
    public ProjectStageAssignCommentListAsyncTaskParam(final Context context, final SettingUserModel settingUserModel, final Integer projectStageId, final ProjectMemberModel projectMemberModel) {
        mContext = context;
