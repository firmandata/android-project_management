...
public class ReportRequestResendAsyncTaskParam {
    ...
    public ReportRequestResendAsyncTaskParam(final Context context, final SettingUserModel settingUserModel, final ReportRequestModel reportRequestModel, final ProjectMemberModel projectMemberModel) {
        mContext = context;
