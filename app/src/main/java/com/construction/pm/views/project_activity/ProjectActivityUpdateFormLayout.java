...
public class ProjectActivityUpdateFormLayout {
    ...
    public void alertDialogShow(final String alertTitle, final String alertMessage, final int iconId, final DialogInterface.OnClickListener onClickListener) {
        ...
        alertDialog.setPositiveButton(ViewUtil.getResourceString(mContext, R.string.project_activity_update_form_view_alert_button), onClickListener);
        alertDialog.show();
    }

    public void alertDialogErrorShow(final String errorMessage) {
        alertDialogShow(ViewUtil.getResourceString(mContext, R.string.project_activity_update_form_view_alert_title_error), errorMessage, R.drawable.cancel_2_24, null);
    }
    ...
    public void loadLayoutToActivity(final AppCompatActivity activity) {
        ...
        if (mActionBar != null) {
            mActionBar.setTitle(R.string.project_activity_update_form_title);
