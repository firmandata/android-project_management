...
public class ManagerLayout implements ProjectActivityListFragment.ProjectActivityListFragmentListener {
    ...
    public void setLayoutData(final ProjectActivityModel[] projectActivityModels) {
        ...
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, null, projectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_all));
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, StatusTaskEnum.IN_PROGRESS, inProgressProjectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_in_progress));
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, StatusTaskEnum.COMING_DUE, comingDueProjectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_coming_due));
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, StatusTaskEnum.SHOULD_HAVE_STARTED, shouldHaveStartedProjectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_should_have_started));
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, StatusTaskEnum.LATE, lateProjectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_late));
        mViewPagerAdapter.addFragment(ProjectActivityListFragment.newInstance(ProjectActivityListTypeEnum.MANAGER, StatusTaskEnum.COMPLETED, completedProjectActivityModels, this), ViewUtil.getResourceString(mContext, R.string.manager_layout_tab_completed));
