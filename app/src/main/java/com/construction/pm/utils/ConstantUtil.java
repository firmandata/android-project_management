...
public class ConstantUtil {
    ...
    public static final int INTENT_REQUEST_PROJECT_ACTIVITY_UPDATE_DETAIL = 1000;
    public static final int INTENT_REQUEST_PROJECT_ACTIVITY_UPDATE_DETAIL_RESULT_EDIT = 1001;
    ...
    public static final int INTENT_REQUEST_PROJECT_STAGE_ASSIGN_COMMENT_DETAIL = 1100;
    public static final int INTENT_REQUEST_PROJECT_STAGE_ASSIGN_COMMENT_DETAIL_RESULT_EDIT = 1101;
